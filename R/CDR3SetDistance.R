#' Comparison function between two sets of TCRs generated by SPANTCR
#'
...
ComparisonFunction <- function(baseset, compset, limit=100, ticks=FineBinTicks, functionmatrix=BLOSUMCappedDiff, fulloutput=F)
{
  ...
  CumulativeDistances <- data.table::data.table(matrix(data=0, nrow=length(CompOriginsMasterOrder),
                                           ...
                                           dimnames = list(compset@CloneData$CDR3[CompOriginsMasterOrder],
                                                           baseset@CloneData$CDR3[BaseOriginsMasterOrder])))
  ...
  CumulativeDistanceComparisons <- data.table::data.table(BaseCDR3 = baseset@CloneData$CDR3,
  ...
  CumulativeDistanceComparisons[, Top5Chain := lapply(Top5CompIndex, function(topindex) compset@CloneData$CDR3[topindex])]
